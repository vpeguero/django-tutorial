...
def create_question(question_text, days):
    """
    Creates a question with the given 'question_text' and published with the given number
    of 'days' offset to now (negative for question published in the past, positive for questions
...
class QuestionViewTests(TestCase):
    ...
    def test_index_with_view_with_a_past_question(self):
        """
    ...
    def test_index_view_with_a_future_question(self):
        """
        Question with a pub_date in the future should not be displayed in the index page.
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_post_question(self):
        """
        Ths detail view of a question with a pub_date in the past should display the question's text.
        """
